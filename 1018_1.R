...
library(openxlsx)
df = read.xlsx("D:/RScripts2024-2/국내지진목록.xlsx", sheet=1, startRow = 4, colNames = FALSE)
head(df)

#x8 열에서 북한으로 시작하는 데이터의 행번호 추출
...
map = st_read("D:/RScripts2024-2/Z_NGII_N3A_G0010000.shp")
